...
<div class="flex items-center gap-5">
  <a
    href="{{ $href }}"
    title="{{ $title }}"
    class="inline-flex items-center gap-2 p-2 hover:bg-blue-50 transition border border-gray-300 text-sm font-medium bg-white rounded-lg text-brand-500 shadow-theme-xs"
  >
