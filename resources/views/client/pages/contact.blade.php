            ...
            <div class="lg:col-span-1">
                ...
                <div class="mt-8">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="https://wa.me/2290141122828" target="_blank" class="w-10 h-10 bg-green-500 text-white rounded-full flex items-center justify-center hover:bg-green-600 transition-colors">
...
<section class="py-12 bg-brand-500">
    <div class="container mx-auto px-4 text-center">
        ...
        <a href="https://wa.me/2290141122828" target="_blank" class="inline-flex items-center bg-white text-brand-600 font-semibold px-8 py-3 rounded-lg hover:bg-gray-100 transition-colors">
