<div
  class="rounded-2xl border border-gray-200 bg-white px-5 pt-5 pb-5 sm:px-6 sm:pt-6"
>
  <div class="mb-6 flex flex-col gap-5 sm:flex-row sm:justify-between">
    <div class="w-full">
      ...
      <p class="text-theme-sm mt-1 text-gray-500">
    ...
    <div class="flex w-full items-start gap-3 sm:justify-end">
      ...
      >
        <button
          ...
          class="text-theme-sm rounded-md px-3 py-2 font-medium hover:text-gray-900"
        >
          Overview
        </button>
        <button
      ...
      <div class="relative max-w-41">
        <input
          class="datepicker text-theme-sm shadow-theme-xs h-10 w-full max-w-11 rounded-lg border border-gray-200 bg-white py-2.5 pr-4 pl-[34px] font-medium text-gray-700 focus:ring-0 focus:outline-hidden focus-visible:outline-hidden xl:max-w-fit xl:pl-11"
